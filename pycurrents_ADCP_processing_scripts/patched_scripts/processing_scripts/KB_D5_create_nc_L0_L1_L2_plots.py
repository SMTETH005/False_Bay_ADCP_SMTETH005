...
f = './project_data/updated_project_data/SMTETH005_KB_RDIWH_20151203_20160304_D5/SMTETH005_KB_RDIWH_20151203_20160304_D5.pd0' 
meta = './project_data/updated_project_data/SMTETH005_KB_RDIWH_20151203_20160304_D5/SMTETH005_KB_RDIWH_20151203_20160304_D5_metadata.csv'
dest_dir = './processed_data/SMTETH005_pycurrents_processed_KB_RDIWH_20151203_20160304_D5'
...
for n in ncnames_L1:
    ...
    plot_list = plot_westcoast_nc_LX.create_westcoast_plots(
        ...
        along_angle=113,               # Alongshore angle (degrees CCW from East) # None for automatic
        colourmap_lim=(-0.8, 0.8),     # Limits for all pcolormesh plots in m/s
        time_slice=None, # set to None for full time range otherwise ("2015-06-01 00:00:00", "2015-07-01 00:00:00")
